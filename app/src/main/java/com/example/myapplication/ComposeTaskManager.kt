...
class ComposeTaskManager : ComponentActivity() {
            ...
            MyApplicationTheme {
                Surface(
                    ...
                    CreateTaskManager(
                        ...
                        tagline = stringResource(R.string.nice_work)
                    )
                }
            }
        }
    ...
    @Composable
    fun CreateTaskManager(message: String, tagline: String, modifier: Modifier = Modifier){
    ...
    @Composable
    private fun CreateTaskManagerPreview(){
        CreateTaskManager(message = "All tasks completed", tagline = "Nice work!")
    }
}